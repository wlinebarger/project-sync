...
public class StatisticsUtilsTest {
    private static final TestLogger testLogger = TestLoggerFactory.getTestLogger(StatisticsUtils.class);
    private BaseSyncStatistics syncStatistics;

    @Test
    public void logStatistics_WithProductSyncStatistics_ShouldLogStatistics() throws JsonProcessingException {
